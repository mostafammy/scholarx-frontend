      ...
      if (isMobile) {
        ...
        return (
          <>
            ...
            <button
              className="sx-mobile-nav-item sx-logout-mobile-btn"
          ...
          <div className="sx-user-avatar-wrapper">
            ...
            {dropdownOpen && (
              <div className="sx-user-dropdown">
                <button onClick={handleProfile} className="sx-dropdown-item">
                  My Profile
                </button>
    ...
    <>
      <nav className="sx-navbar">
        <div className="sx-container">
          ...
          <div
            className={`sx-navbar-links col-md-6 d-md-flex justify-content-center ${mobileMenuOpen ? "sx-active" : ""}`}
          >
            <Link
              to="/"
              className={currentPath === "/" ? "sx-active" : ""}
              onClick={closeMobileMenu}
            >
              Home
            </Link>
            <Link
              to="/about"
              className={currentPath === "/about" ? "sx-active" : ""}
              onClick={closeMobileMenu}
            >
              About Us
            </Link>
            <Link
              to="/services"
              className={currentPath === "/services" ? "sx-active" : ""}
              onClick={closeMobileMenu}
            >
              Our Services
            </Link>
            <div className="sx-dropdown">
              <Link
                to="/courses"
                className={currentPath === "/courses" ? "sx-active" : ""}
                onClick={closeMobileMenu}
              >
                Courses
              </Link>
            ...
            <Link
              to="/contact"
              className={currentPath === "/contact" ? "sx-active" : ""}
              onClick={closeMobileMenu}
            >
              Contact
            </Link>

            <div className="sx-mobile-auth">{renderAuthButtons(true)}</div>
          </div>
