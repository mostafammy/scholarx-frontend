...
export const WORKSHOP_OPTIONS = Object.freeze([
  { value: 'cv-writing', label: 'CV & Cover Letter Masterclass', track: 'Career Excellence' },
  { value: 'linkedin-branding', label: 'LinkedIn & Digital Personal Branding', track: 'Skills Development' },
  { value: 'scholarship-essay', label: 'Scholarship Essay Writing', track: 'Global Education' },
  { value: 'ai-tools', label: 'AI Tools for Students & Professionals', track: 'Skills Development' },
  { value: 'interview-prep', label: 'Interview Preparation & Mock Interviews', track: 'Career Excellence' },
  { value: 'green-entrepreneurship', label: 'Green Entrepreneurship & Sustainability', track: 'Innovation & Impact' },
  { value: 'cybersecurity', label: 'Cybersecurity Fundamentals', track: 'Skills Development' },
  { value: 'fulbright', label: 'Fulbright & US Scholarships Workshop', track: 'Global Education' },
  { value: 'erasmus', label: 'Erasmus+ & EU Scholarships Workshop', track: 'Global Education' },
  { value: 'research-methods', label: 'Research Methods & Academic Writing', track: 'Global Education' },
  { value: 'startup-pitch', label: 'Startup Pitching & Fundraising', track: 'Innovation & Impact' },
  { value: 'public-speaking', label: 'Public Speaking & Leadership', track: 'Career Excellence' },
  { value: 'freelancing', label: 'Freelancing & Remote Work', track: 'Skills Development' },
  { value: 'stem-policy', label: 'STEM Advocacy & Policy Influence', track: 'Innovation & Impact' },
  { value: 'networking', label: 'Strategic Networking & Relationship Building', track: 'Career Excellence' },
  { value: 'data-science', label: 'Data Science for Decision Makers', track: 'Skills Development' },
]);
