...
export const SUMMIT_TRACKS = Object.freeze([
  {
    ...
    color: "#f5c518",
    gradient:
      "linear-gradient(135deg, rgba(245,197,24,0.15), rgba(255,165,0,0.05))",
  ...
  },
  {
    ...
    color: "#4fc3f7",
    gradient:
      "linear-gradient(135deg, rgba(79,195,247,0.15), rgba(0,87,248,0.05))",
  ...
  },
  {
    ...
    color: "#ff8a65",
    gradient:
      "linear-gradient(135deg, rgba(255,138,101,0.15), rgba(255,87,34,0.05))",
  ...
  },
  {
    ...
    color: "#69f0ae",
    gradient:
      "linear-gradient(135deg, rgba(105,240,174,0.15), rgba(0,200,150,0.05))",
...
export const SUMMIT_PARTNERS = Object.freeze([
  ...
  },
  {
    ...
    tagline:
      "Connecting youth in the Southern Neighbourhood to global opportunities",
    description:
