            ...
            >
              ...
              >
                <svg
                  ...
                  aria-hidden="true"
                >
                  <rect x="8" y="2" width="32" height="44" rx="4" fill="#673AB7" fillOpacity="0.9" />
                  <rect x="8" y="2" width="32" height="44" rx="4" fill="url(#gf-grad2)" fillOpacity="0.15" />
                  <rect x="14" y="14" width="20" height="2.5" rx="1.25" fill="white" fillOpacity="0.9" />
                  <rect x="14" y="20" width="14" height="2.5" rx="1.25" fill="white" fillOpacity="0.6" />
                  <rect x="14" y="26" width="17" height="2.5" rx="1.25" fill="white" fillOpacity="0.6" />
                  <rect x="14" y="32" width="11" height="2.5" rx="1.25" fill="white" fillOpacity="0.5" />
                  <defs>
                    <linearGradient id="gf-grad2" x1="8" y1="2" x2="40" y2="46" gradientUnits="userSpaceOnUse">
