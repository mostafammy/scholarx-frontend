    ...
    <div className="summit-container">
      <div className="summit-footer-inner">
        ...
        <nav className="summit-footer-links" aria-label="Footer navigation">
          <a href="#summit-journey" className="summit-footer-link">Journey</a>
          <a href="#summit-tracks" className="summit-footer-link">Tracks</a>
          <a href="#summit-partners" className="summit-footer-link">Partners</a>
          <a href="#registration" className="summit-footer-link">Register</a>
      ...
      <p className="summit-footer-copyright">
        © {new Date().getFullYear()} {EVENT_META.organizers.join(' & ')}. All rights reserved.{' '}
        Organized with excellence at{' '}
        <strong style={{ color: 'var(--s-text-200)' }}>{EVENT_META.venue}</strong>.
      </p>
    </div>
  </footer>
);
