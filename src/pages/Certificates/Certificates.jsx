...
const Certificates = () => {
  ...
  const { completedCourses, loadingCourses, error } = useSelector(
    ...
    <div className={styles.container}>
      <div className={styles.header}>
        ...
        <p className={styles.subtitle}>
          Congratulations on completing your courses! Here are your certificates
          of completion.
        </p>
      </div>
          ...
          <div className={styles.modalContent}>
            ...
            <Certificate
              certificate={{
                ...
                courseId: selectedCertificate.course._id, // Required for PDF download
